...
void test_create_destroy()
{
  ...
  ioopm_linked_list_append(list2, int_elem(55));
...
void test_remove_link()
{
  ...
  CU_ASSERT_TRUE(ioopm_linked_list_contains(list, int_elem(35)));
...
void test_clear()
{
  ...
  ioopm_linked_list_prepend(list, int_elem(25));
  ioopm_linked_list_insert(list, 1, int_elem(11111));
  ioopm_linked_list_insert(list, 2, int_elem(22222)); // DUMMY-> [11111]->[25]->[22222]->[35]->[45]->[55]
...
{
  bool keys_bigger_value(int key, elem_t value, void *x)
  {
    return (key > value.i);
  }
  ...
  ioopm_linked_list_append(list, int_elem(55));
  ioopm_linked_list_append(list, int_elem(56));
  ioopm_linked_list_append(list, int_elem(57));
  CU_ASSERT_FALSE(ioopm_linked_list_all(list, keys_bigger_value, NULL));
  ioopm_linked_list_destroy(list);
}
...
{
  bool value_bigger_keys(int key, elem_t value, void *x)
  {
    return (value.i > key);
  }
  ...
  ioopm_linked_list_prepend(list, int_elem(-35));
  ioopm_linked_list_append(list, int_elem(5));                           // order: [-35]->[-4]->[3]->[-7]->[5]
...
{
  void increase_small_keys(int key, elem_t *value, void *x)
  {
    if (key <= 5)
    {
      *value = int_elem(500);
  ...
  ioopm_linked_list_insert(list, 4, int_elem(5));
  ioopm_linked_list_insert(list, 5, int_elem(6));
...
void test_next_iter(){
  ...
  ioopm_linked_list_append(list, int_elem(100));
  ioopm_linked_list_append(list, int_elem(200));   // [22]->[233]->[100]->[200]
